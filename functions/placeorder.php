...
if(isset($_SESSION['auth']))
{
    ...
    if(isset($_POST['placeOrderBtn']))
    {
        ...
        $tracking_no = "ORDERSC".rand(1111,9999).substr($phone,2);
        $insert_query = "INSERT INTO orders 
        (tracking_no, user_id, name, email, phone, address, pincode, total_price, status, payment_status, payment_mode, payment_id ) 
        VALUES ('$tracking_no', '$userId', '$name', '$email', '$phone', '$address', '$pincode', '$totalPrice','$status','$payment_status', '$payment_mode', '$payment_id') ";
