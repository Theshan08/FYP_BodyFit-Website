                    ...
                    <form action="code.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea rows="3" required name="description" placeholder="Enter description" class="form-control mb-2 mySummernote"></textarea>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="checkbox" name="is_supplement" class="me-1" style="width:20px;height:20px;" id="isSupplement">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="checkbox" style="width:20px;height:20px;" name="status" id="status">
                                    <br>
                                    <small>Checked = hidden, Unchecked = visible</small>
                                </div>
                                <div class="col-md-3">
                                    <label class="mb-0" for="trending">Trending</label> <br>
                                    <input type="checkbox" style="width:20px;height:20px;" name="trending" id="trending">
                                </div>
                            </div>
                            <div class="col-md-12">
