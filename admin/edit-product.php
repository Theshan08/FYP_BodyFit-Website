                                        ...
                                        <form action="code.php" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea rows="3" required name="description" placeholder="Enter description" class="form-control mb-2 mySummernote"><?= $data['description']; ?></textarea>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="py-2">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="mb-2">
                                                                    <label class="mb-0">Goal</label>
                                                                    <select name="goal" class="form-select" id="" >
                                                                        <option value="build_muscle" <?= $data['goal'] == 'build_muscle'?'selected':''; ?> >Build Muscle</option>
                                                                        <option value="lose_weight" <?= $data['goal'] == 'lose_weight'?'selected':''; ?>>Lose Weight</option>
                                                                        <option value="get_lean" <?= $data['goal'] == 'get_lean'?'selected':''; ?>>Get Lean</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="mb-2">
                                                                    ...
                                                                    <select name="diet" class="form-select" id="" >
                                                                        <option value="noDiet_requirement" <?= $data['goal'] == 'noDiet_requirement'?'selected':''; ?> >No dietary requirement</option>
                                                                        <option value="vegan" <?= $data['goal'] == 'vegan'?'selected':''; ?> >Vegan</option>
                                                                        <option value="vegetarian" <?= $data['goal'] == 'vegetarian'?'selected':''; ?> >Vegetarian</option>
                                                                        <option value="gluten_free" <?= $data['goal'] == 'gluten_free'?'selected':''; ?> >Gluten-Free</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="mb-2">
                                                                    <label class="mb-1" for="isSupplement">Is Supplement (Show in recommendation?)</label>  <br>
                                                                    <input type="checkbox" name="is_supplement" class="me-1" <?= $data['is_supplement'] == '1'?'checked':''; ?> style="width:20px;height:20px;" id="isSupplement">
                                                                    <small style="font-size: 12px;">Checked = Show in recommendations</small>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="checkbox" id="status" style="width:20px;height:20px;" name="status" <?= $data['status'] == '0'?'':'checked' ?>>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="mb-0" for="trending">Trending</label> <br>
                                                        <input type="checkbox" id="trending" style="width:20px;height:20px;" name="trending" <?= $data['trending'] == '0'?'':'checked' ?>>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
